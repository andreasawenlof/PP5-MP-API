...
class AlbumSerializer(serializers.ModelSerializer):
    ...
    mood = serializers.SlugRelatedField(queryset=Mood.objects.all(
    ), slug_field="name", required=False, allow_null=True)
    project_type = serializers.SlugRelatedField(queryset=ProjectType.objects.all(
    ), slug_field="name", required=False, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'project_type', 'genre', 'mood', 'created_at', 'updated_at',
            'tracks', 'track_ids'
        ]
    ...
    def get_tracks(self, obj):
        ...
        """
        serializer_class = DetailedTrackSerializer if self.context.get(
    ...
    def to_representation(self, instance):
        ...
        data['track_ids'] = list(instance.tracks.values_list(
            'id', flat=True))  # ✅ Fix for preselected tracks
        return data
